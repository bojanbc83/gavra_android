...
void main() {
  ...
  final List<Map<String, dynamic>> addresses = [
    ...
    {
      "naziv": "Centar Milenijum",
      "grad": "Vršac",
      "db_lat": 45.117974,
      "db_lng": 21.31086
    },
    {
      "naziv": "Prima pumpa (MOL)",
      "grad": "Vršac",
      "db_lat": 45.1027318,
      "db_lng": 21.2985089
    },
  ...
  test('Verify Vršac DB Addresses', () async {
    ...
    print('${"ADRESA".padRight(25)} | ${"DB STATUS".padRight(15)} | ${"PHOTON".padRight(15)} | ${"RAZLIKA (m)".padRight(15)}');
    print('-' * 80);
    ...
    for (final item in addresses) {
      ...
      if (dbLat != null && photonRes['found']) {
        ...
        if (dist > 200) diffText += " ❗";
         else diffText += " ✅";
      } else if (dbLat == null && photonRes['found']) {
         diffText = "🆕 PREDLOG";
      }

      print('${naziv.toString().padRight(25)} | ${dbStatus.padRight(15)} | ${photonStatus.padRight(15)} | ${diffText.padRight(15)}');
