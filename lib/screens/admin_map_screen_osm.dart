...
class AdminMapScreenOSM extends StatefulWidget {
  const AdminMapScreenOSM({Key? key}) : super(key: key);

  @override
  State<AdminMapScreenOSM> createState() => _AdminMapScreenOSMState();
}

class _AdminMapScreenOSMState extends State<AdminMapScreenOSM> {
