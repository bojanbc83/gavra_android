  ...
  static Future<void> _registerToken(String provider, String token, String platform) async {
    try {
      ...
      if (e.toString().contains('404') || e.toString().contains('Not Found')) {
        debugPrint('PushService: push_players table not found. Please run the migration first.');
        debugPrint('PushService: Run the SQL from apply_push_migration.sql in your Supabase dashboard');
      } else {
