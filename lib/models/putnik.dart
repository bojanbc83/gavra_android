...
class Putnik {
  ...
  factory Putnik.fromMesecniPutnici(Map<String, dynamic> map) {
    return Putnik(
      ...
      vremePokupljenja: map['poslednje_putovanje'] != null
          ...
          : null,
      vremePlacanja: map['datum_pocetka_meseca'] != null
          ? DateTime.parse(map['datum_pocetka_meseca'])
          : null,
      placeno: false, // mesečni putnici ne plaćaju po vožnji
      iznosPlacanja: null, // mesečni putnici nemaju specifične iznose
      naplatioVozac: null, // mesečni putnici nemaju specifičnog vozača
      dodaoVozac: null, // mesečni putnici nemaju specifičnog vozača
      vozac: null, // mesečni putnici nemaju specifičnog vozača
  ...
  static List<Putnik> fromMesecniPutniciMultiple(Map<String, dynamic> map) {
    ...
    final vremePokupljenja = map['poslednje_putovanje'] != null
        ...
        : null;
    final vremePlacanja = map['datum_pocetka_meseca'] != null
        ? DateTime.parse(map['datum_pocetka_meseca'])
        : null;
    const placeno = false; // mesečni putnici ne plaćaju po vožnji
    const iznosPlacanja = null; // mesečni putnici nemaju specifične iznose
