/// REMOVED: Compile-time feature flags. Use your CI or `flutter define` for environment-specific toggles.
/// This file remains as a historical placeholder; remove if no imports reference it.
class FeatureFlags {
  ///
  /// **Migration status:**
  ...
  // NOTE: All feature flags removed from codebase. The rest of the file intentionally wiped.
}
