...
\restrict 8ThHZijrgy6jxDwHrMk3mhHwoaWHvT4ZyW3BF2CAAJeYgGLeJxr3hFLkI0Mm827
...
--
-- Name: azuriraj_statistike_mesecnog_putnika(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.azuriraj_statistike_mesecnog_putnika(putnik_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: enqueue_putovanja_notification(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enqueue_putovanja_notification() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: get_broj_putovanja_za_mesecnog(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_broj_putovanja_za_mesecnog(putnik_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN (
...
--
-- Name: get_latest_gps_locations(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_latest_gps_locations() RETURNS TABLE(vozac_id text, lat double precision, lng double precision, gps_timestamp timestamp with time zone)
    LANGUAGE sql
    AS $$
...
--
-- Name: refresh_reports(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.refresh_reports() RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: set_week_month_year(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_week_month_year() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE TABLE public.adrese (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    ulica character varying(200) NOT NULL,
    broj character varying(10),
...
CREATE TABLE public.dnevni_putnici (
    ...
    CONSTRAINT dnevni_putnici_priority_check CHECK (((priority >= 1) AND (priority <= 5)))
);


--
-- Name: gps_lokacije; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.mesecni_putnici (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    putnik_ime character varying(100) NOT NULL,
    tip character varying(50) NOT NULL,
    tip_skole character varying(100),
    broj_telefona character varying(20),
    polasci_po_danu jsonb NOT NULL,
    tip_prikazivanja character varying(50) DEFAULT 'standard'::character varying,
    radni_dani character varying(50),
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT mesecni_putnici_placena_godina_check CHECK ((placena_godina >= 2020)),
    CONSTRAINT mesecni_putnici_placeni_mesec_check CHECK (((placeni_mesec >= 1) AND (placeni_mesec <= 12)))
);


--
-- Name: putovanja_istorija; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.putovanja_istorija (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    mesecni_putnik_id uuid,
    tip_putnika character varying(20) NOT NULL,
    datum date NOT NULL,
    vreme_polaska time without time zone NOT NULL,
    vreme_akcije timestamp with time zone,
    status character varying(50) DEFAULT 'nije_se_pojavio'::character varying NOT NULL,
    putnik_ime character varying(100) NOT NULL,
    broj_telefona character varying(20),
    cena numeric(10,2) DEFAULT 0.0,
    dan character varying(10),
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT putovanja_istorija_tip_putnika_check CHECK (((tip_putnika)::text = ANY ((ARRAY['mesecni'::character varying, 'dnevni'::character varying])::text[])))
);


--
-- Name: rute; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.rute (
    ...
    polazak character varying(100) NOT NULL,
    dolazak character varying(100) NOT NULL,
    udaljenost_km numeric(5,2),
...
--
-- Name: vozaci; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: vozila; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.vozila (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    registarski_broj character varying(20) NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT vozila_broj_sedista_check CHECK ((broj_sedista > 0))
);
...
--
-- Name: dnevni_putnici dnevni_putnici_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gps_lokacije gps_lokacije_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rute rute_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vozaci vozaci_ime_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vozaci vozaci_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vozila vozila_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vozila vozila_registarski_broj_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_dnevni_putnici_datum; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dnevni_putnici_datum ON public.dnevni_putnici USING btree (datum);


--
-- Name: idx_dnevni_putnici_grad; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dnevni_putnici_grad ON public.dnevni_putnici USING btree (grad);


--
-- Name: idx_dnevni_putnici_obrisan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dnevni_putnici_obrisan ON public.dnevni_putnici USING btree (obrisan);


--
-- Name: idx_dnevni_putnici_ruta; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dnevni_putnici_ruta ON public.dnevni_putnici USING btree (ruta_id);


--
-- Name: idx_dnevni_putnici_vozac; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dnevni_putnici_vozac ON public.dnevni_putnici USING btree (vozac_id);


--
-- Name: idx_gps_lokacije_vozac; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gps_lokacije_vozac ON public.gps_lokacije USING btree (vozac_id);


--
-- Name: idx_gps_lokacije_vozilo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gps_lokacije_vozilo ON public.gps_lokacije USING btree (vozilo_id);


--
-- Name: idx_gps_lokacije_vreme; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gps_lokacije_vreme ON public.gps_lokacije USING btree (vreme);


--
-- Name: idx_mesecni_putnici_aktivan; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mesecni_putnici_obrisan; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mesecni_putnici_placeni_mesec; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mesecni_putnici_placeni_mesec ON public.mesecni_putnici USING btree (placeni_mesec, placena_godina);


--
-- Name: idx_mesecni_putnici_ruta; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mesecni_putnici_ruta ON public.mesecni_putnici USING btree (ruta_id);


--
-- Name: idx_mesecni_putnici_vozac; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mesecni_putnici_vozac ON public.mesecni_putnici USING btree (vozac_id);


--
-- Name: idx_putovanja_istorija_datum; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_putovanja_istorija_mesecni_putnik; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_putovanja_istorija_obrisan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_putovanja_istorija_obrisan ON public.putovanja_istorija USING btree (obrisan);


--
-- Name: idx_putovanja_istorija_vozac; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_putovanja_istorija_vozac ON public.putovanja_istorija USING btree (vozac_id);
...
--
-- Name: dnevni_putnici update_dnevni_putnici_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_dnevni_putnici_updated_at BEFORE UPDATE ON public.dnevni_putnici FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: mesecni_putnici update_mesecni_putnici_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_mesecni_putnici_updated_at BEFORE UPDATE ON public.mesecni_putnici FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: putovanja_istorija update_putovanja_istorija_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_putovanja_istorija_updated_at BEFORE UPDATE ON public.putovanja_istorija FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: rute update_rute_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_rute_updated_at BEFORE UPDATE ON public.rute FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: vozaci update_vozaci_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_vozaci_updated_at BEFORE UPDATE ON public.vozaci FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: vozila update_vozila_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_vozila_updated_at BEFORE UPDATE ON public.vozila FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: dnevni_putnici dnevni_putnici_adresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_dodao_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_naplatio_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_otkazao_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_pokupio_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_ruta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dnevni_putnici dnevni_putnici_vozilo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gps_lokacije gps_lokacije_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gps_lokacije gps_lokacije_vozilo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_adresa_dolaska_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_adresa_polaska_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_ruta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: mesecni_putnici mesecni_putnici_vozilo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_adresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_mesecni_putnik_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_ruta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_vozac_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: putovanja_istorija putovanja_istorija_vozilo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gps_lokacije Allow anon insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon insert" ON public.gps_lokacije FOR INSERT WITH CHECK (true);


--
-- Name: vozaci Allow anon insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon insert" ON public.vozaci FOR INSERT WITH CHECK (true);


--
-- Name: vozaci Allow anon select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon select" ON public.vozaci FOR SELECT USING (true);


--
-- Name: adrese Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.adrese USING ((auth.role() = 'authenticated'::text));


--
-- Name: dnevni_putnici Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.dnevni_putnici USING ((auth.role() = 'authenticated'::text));


--
-- Name: mesecni_putnici Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.mesecni_putnici USING ((auth.role() = 'authenticated'::text));


--
-- Name: putovanja_istorija Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.putovanja_istorija USING ((auth.role() = 'authenticated'::text));


--
-- Name: rute Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.rute USING ((auth.role() = 'authenticated'::text));


--
-- Name: vozila Enable all operations for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Enable all operations for authenticated users" ON public.vozila USING ((auth.role() = 'authenticated'::text));


--
-- Name: adrese; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.adrese ENABLE ROW LEVEL SECURITY;

--
-- Name: dnevni_putnici; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.dnevni_putnici ENABLE ROW LEVEL SECURITY;

--
-- Name: gps_lokacije; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.gps_lokacije ENABLE ROW LEVEL SECURITY;

--
-- Name: mesecni_putnici; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.mesecni_putnici ENABLE ROW LEVEL SECURITY;

--
-- Name: putovanja_istorija; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.putovanja_istorija ENABLE ROW LEVEL SECURITY;

--
-- Name: rute; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.rute ENABLE ROW LEVEL SECURITY;

--
-- Name: vozaci; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.vozaci ENABLE ROW LEVEL SECURITY;

--
-- Name: vozila; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime adrese; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime dnevni_putnici; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime gps_lokacije; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime mesecni_putnici; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime putovanja_istorija; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime rute; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime vozaci; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime vozila; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
\unrestrict 8ThHZijrgy6jxDwHrMk3mhHwoaWHvT4ZyW3BF2CAAJeYgGLeJxr3hFLkI0Mm827
